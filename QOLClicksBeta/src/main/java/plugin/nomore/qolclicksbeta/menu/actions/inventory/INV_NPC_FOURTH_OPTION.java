...
public class INV_NPC_FOURTH_OPTION
{
    ...
    {
        WidgetItem itemClicked = inventory.getItemInSlot(utils.getConfigInt(0, config.INV_NPC_FOURTH_OPTION_CONFIG_STRING()), e.getActionParam());
        NPC npcToUseItemOn = npc.getClosestNpc(utils.getConfigInt(1, config.INV_NPC_FOURTH_OPTION_CONFIG_STRING()));
        if (itemClicked == null
                || npcToUseItemOn == null)
        {
            return;

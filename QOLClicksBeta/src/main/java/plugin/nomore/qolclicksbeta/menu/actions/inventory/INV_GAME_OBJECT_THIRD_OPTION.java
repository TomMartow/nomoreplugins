...
public class INV_GAME_OBJECT_THIRD_OPTION
{
    ...
    {
        WidgetItem itemClicked = inventory.getItemInSlot(utils.getConfigInt(0, config.INV_GAME_OBJECT_THIRD_OPTION_CONFIG_STRING()), e.getActionParam());
        GameObject gameObjectToInteractWith = gameObj.getClosestGameObject(utils.getConfigInt(1, config.INV_GAME_OBJECT_THIRD_OPTION_CONFIG_STRING()));
        if (itemClicked == null

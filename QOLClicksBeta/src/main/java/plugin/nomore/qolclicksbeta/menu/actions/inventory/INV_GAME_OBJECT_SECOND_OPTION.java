...
public class INV_GAME_OBJECT_SECOND_OPTION
{
    ...
    {
        WidgetItem itemClicked = inventory.getItemInSlot(utils.getConfigInt(0, config.INV_GAME_OBJECT_SECOND_OPTION_CONFIG_STRING()), e.getActionParam());
        GameObject gameObjectToInteractWith = gameObj.getClosestGameObject(utils.getConfigInt(1, config.INV_GAME_OBJECT_SECOND_OPTION_CONFIG_STRING()));
        if (itemClicked == null
        ...
        MenuEntry menuEntry = new MenuEntry(
                config.INV_GAME_OBJECT_SECOND_OPTION_MENU_OPTION(),
                "<col=ff9040>"

...
public class INV_GAME_OBJECT_SECOND_OPTION
{
    ...
    {
        WidgetItem itemClicked = inventory.getItemInSlot(utils.getConfigArg(0, config.INV_GAME_OBJECT_SECOND_OPTION_CONFIG_STRING()), e.getActionParam());
        GameObject gameObjectToInteractWith = gameObj.getClosestGameObject(utils.getConfigArg(1, config.INV_GAME_OBJECT_SECOND_OPTION_CONFIG_STRING()));
        if (itemClicked == null

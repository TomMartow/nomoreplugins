...
public class INV_NPC_FIFTH_OPTION
{
    ...
    {
        WidgetItem itemClicked = inventory.getItemInSlot(utils.getConfigArg(0, config.INV_NPC_FIFTH_OPTION_CONFIG_STRING()), e.getActionParam());
        NPC npcToUseItemOn = npc.getClosestNpc(utils.getConfigArg(1, config.INV_NPC_FIFTH_OPTION_CONFIG_STRING()));
        if (itemClicked == null
                || npcToUseItemOn == null)
        {
            return;

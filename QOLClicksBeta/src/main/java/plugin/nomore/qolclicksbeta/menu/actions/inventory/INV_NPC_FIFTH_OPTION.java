...
public class INV_NPC_FIFTH_OPTION
{
    ...
    {
        WidgetItem itemClicked = inventory.getItemInSlot(utils.getConfigInt(0, config.INV_NPC_FIFTH_OPTION_CONFIG_STRING()), e.getActionParam());
        NPC npcToUseItemOn = npc.getClosestNpc(utils.getConfigInt(1, config.INV_NPC_FIFTH_OPTION_CONFIG_STRING()));
        if (itemClicked == null
                || npcToUseItemOn == null)
        {
            return;
        ...
        MenuEntry menuEntry = new MenuEntry(
                config.INV_NPC_FIFTH_OPTION_MENU_OPTION(),
                "<col=ff9040>"

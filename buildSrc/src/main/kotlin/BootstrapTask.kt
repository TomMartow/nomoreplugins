...
open class BootstrapTask : DefaultTask() {
    ...
    private fun getBootstrap(): JSONArray? {
        ...
        val url = "https://raw.githubusercontent.com/TomMartow/NoMorePlugins/master/plugins.json"
            ...
            project.subprojects.forEach {
                if (it.project.properties.containsKey("PluginName") && it.project.properties.containsKey("PluginDescription")) {
                    ...
                    releases.add(JsonBuilder(
                            ...
                            "url" to "https://github.com/TomMartow/NoMorePlugins/blob/master/release/${it.project.name}-${it.project.version}.jar?raw=true",
